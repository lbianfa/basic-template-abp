...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 96bc43fd-27e3-4f25-98ff-3eea273736d5
```

> `96bc43fd-27e3-4f25-98ff-3eea273736d5` is the password of the certificate, you can change it to any password you want.

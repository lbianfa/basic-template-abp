...
namespace BookStore.Authors
{
    ...
    where TStartupModule : IAbpModule
    {
        ...
        {
            var result = await _authorAppService.GetListAsync(new GlobalDtos.PagedSortedAndFilteredResultRequestDto());
        ...
        public async Task Should_Get_Filtered_Authors()
        {
            var result = await _authorAppService.GetListAsync(
                new GlobalDtos.PagedSortedAndFilteredResultRequestDto { Filter = "George" });
